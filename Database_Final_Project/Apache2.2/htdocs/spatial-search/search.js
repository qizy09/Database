...
function doSearch(query) {
    var url = location.protocol + '//' + location.host +"/fcgi-bin/SpacialSearch4.fcgi?" + "kw=" + query + "&lat=" + mymarker.getPosition().lat()+ "&lng=" + mymarker.getPosition().lng();//"http://59.66.133.37/fcgi-bin/SpacialSearch.fcgi";
    url = encodeURI(url);
